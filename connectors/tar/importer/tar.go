...
func NewTarImporter(ctx *appcontext.AppContext, name string, config map[string]string) (importer.Importer, error) {
...
func (t *TarImporter) Origin() string { return t.ctx.Hostname }
