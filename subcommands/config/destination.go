...
func ConfigDestination(ctx *appcontext.AppContext, repo *repository.Repository, args []string) error {
	...
	return dispatchSubcommand(ctx, "destination", flags.Args()[0], flags.Args()[1:])
}
